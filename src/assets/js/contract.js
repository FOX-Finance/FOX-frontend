...
const COUPON_CONTRACT_ADDR = address.Coupon;
...
const COUPON_CONTRACT_ABI = COUPON.abi;

export {
    FOX_CONTRACT_ADDR, FOX_CONTRACT_ABI,
    FOXFARM_CONTRACT_ADDR, FOXFARM_CONTRACT_ABI,
    WETH_CONTRACT_ADDR, FOXS_CONTRACT_ADDR,
    SIN_CONTRACT_ADDR, GATEWAY_CONTRACT_ADDR,
    WETH_CONTRACT_ABI, FOXS_CONTRACT_ABI,
    SIN_CONTRACT_ABI, GATEWAY_CONTRACT_ABI,
    COUPON_CONTRACT_ADDR, COUPON_CONTRACT_ABI
};